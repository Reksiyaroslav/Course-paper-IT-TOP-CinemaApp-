...
import random
from app.db.model_db.model_db import (
    Film,
    User,
    Actor,
    Author,
...
from app.db.engine import provide_async_session, engine
...
async def init_db():
    async with engine.begin() as con:
        await con.run_sync(AdvancedDeclarativeBase.metadata.create_all)

...
class ModelRepository(Generic[ModelType]):
    ...
    async def create(self, data: dict) -> ModelType:
        try:
            ...
            if hasattr(structure, "created_at"):
                setattr(structure, "created_at", datetime.datetime.utcnow())
    ...
    async def update_model(self, model_id: UUID, data: dict) -> Optional[ModelType]:
        try:
            ...
            if hasattr(structure, "update_at"):
                setattr(structure, "update_at", datetime.datetime.utcnow())

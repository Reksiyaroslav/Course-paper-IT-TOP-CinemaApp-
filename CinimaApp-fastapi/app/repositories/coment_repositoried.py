...
class ComentRepository():
    ...
    async def  update_type_recon(self,coment_id:uuid.UUID,type_recon:str,relult_recon:str = None):
        ...
        if type_recon == Type_Rec.Like.value and relult_recon != Type_Rec.Like.value:
            coment.countheart +=1
        elif type_recon == Type_Rec.UnLike.value and relult_recon != Type_Rec.UnLike.value:
            coment.countdemon+=1
